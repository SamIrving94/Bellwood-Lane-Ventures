...
export async function POST(request: Request) {
  ...
  const subject = 'Your Kept portal sign-in link';
  const html = `
    <div style="font-family:Inter,Arial,sans-serif;max-width:560px;margin:0 auto;padding:32px;background:#FBF8F5">
      ...
      <p style="color:#2B2220;font-size:16px;line-height:1.6;margin-top:32px">Hi ${agent.contactName},</p>
      <p style="color:#2B2220;font-size:16px;line-height:1.6">Your sign-in link for the Kept agent portal. Valid for 15 minutes.</p>
      <p style="margin:32px 0"><a href="${link}" style="display:inline-block;background:#DB5C5C;color:#2B2220;padding:14px 32px;border-radius:999px;text-decoration:none;font-weight:600">Sign in →</a></p>
      <p style="color:#6B7280;font-size:13px;line-height:1.6">Or paste: <a href="${link}" style="color:#874646">${link}</a></p>
