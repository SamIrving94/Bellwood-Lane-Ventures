...
export function LedgerTicker() {
  return (
    <section
      ...
      className="relative overflow-hidden border-stone-200/60 border-b bg-[#874646] py-3 text-white"
    >
      <div className="ticker-track flex w-max items-center gap-12 whitespace-nowrap">
        {ITEMS.map((item, i) => (
          <div
            key={`${item.text}-${i}`}
            className="flex items-center gap-3 text-xs tracking-wide [font-family:var(--font-courier)]"
          >
            <span
