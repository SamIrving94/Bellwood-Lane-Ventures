...
export const metadata: Metadata = {
  title: 'Seller Disclosure Form · Bellwood Ventures',
  robots: 'noindex',
};
    ...
    <div className="mx-auto max-w-3xl px-8 py-14 print:px-0 print:py-0">
      ...
      <section className="mt-8">
        ...
        <p className="text-sm text-slate-700">
          ...
          with Bellwood. The amount is stated below. This fee is paid by
          Bellwood and is separate from any standard estate agency commission.
        </p>
      ...
      <section className="mt-8">
        ...
        <ol className="space-y-3 text-sm">
          {[
            ...
            'I understand Bellwood is paying a referral fee to my estate agent as disclosed above.',
            'I understand Bellwood is a cash buyer, not an FCA-authorised firm, and is registered for AML supervision with HMRC.',
            'I understand Bellwood will only adjust the offer if a survey reveals material issues previously undisclosed — and I have 48 hours to withdraw free of charge in that scenario.',
      ...
      <section className="mt-8 rounded-xl bg-slate-50 p-6">
        ...
        <p className="text-sm text-slate-700">
          ...
          2024, Bellwood operates additional safeguards where a seller may be
        ...
        <label className="mt-4 flex items-start gap-3 text-sm">
          ...
          <span className="text-slate-700">
            I identify as a vulnerable seller and wish Bellwood&apos;s
      ...
      <footer className="mt-12 border-t border-slate-200 pt-6 text-xs text-slate-500">
        Bellwood Ventures Ltd · NAPB member · TPO redress scheme member · HMRC
