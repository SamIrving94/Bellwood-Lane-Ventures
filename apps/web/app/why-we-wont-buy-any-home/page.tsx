...
export default function WhyWeWontBuyAnyHomePage() {
  return (
    <div className="min-h-screen bg-[#FBF8F5] font-sans text-[#2B2220] antialiased">
      ...
      <section className="px-6 pt-16 pb-12 md:px-12 md:pt-24 md:pb-16">
        <div className="mx-auto max-w-4xl">
          ...
          >
            ...
            <br />
            <span className="text-[#DB5C5C] italic">We won&rsquo;t.</span>
          </h1>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-2">
            {SITUATIONS_WE_BUY.map((s) => (
              <div
                key={s.k}
                className="rounded-md border border-[#EAE0D9] bg-white p-7"
              >
      ...
      {/* ————— WHAT WE WON'T BUY ————— */}
      <section className="border-stone-200/60 border-b bg-[#F6ECE7] px-6 py-20 md:px-12 md:py-28">
        <div className="mx-auto max-w-4xl">
          ...
          <dl className="mt-12 divide-y divide-stone-200 border-stone-200 border-y">
            {SITUATIONS_WE_WONT_BUY.map((s) => (
              <div key={s.k} className="py-7">
                <dt className="font-semibold font-serif text-[#2B2220] text-xl">
                  {s.k}
                </dt>
                <dd className="mt-3 text-[15px] text-stone-700 leading-relaxed">
                  {s.b}
                </dd>
                <dd className="mt-4 rounded-[2px] border border-[#EAE0D9] bg-white px-5 py-4 text-[14px] text-stone-700 leading-relaxed">
                  <span className="font-serif text-[#DB5C5C] text-[13px] italic">
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 space-y-5 text-[15px] text-stone-700 leading-relaxed">
            ...
            <p>
              ...
              <strong>our offer is below open-market.</strong> That gap is what
              pays for a fixed date, a fixed number, and a buyer who is not
              waiting on a mortgage or a chain. If your situation doesn&rsquo;t
              need those things, you don&rsquo;t need us.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* ————— ROUTING ————— */}
      <section className="border-stone-200/60 border-b bg-[#874646] px-6 py-20 text-white md:px-12 md:py-24">
        <div className="mx-auto max-w-4xl">
