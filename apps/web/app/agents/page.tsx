...
function SampleOfferDocument() {
  return (
    <div className="relative mx-auto max-w-md rounded-sm border border-[#E4D8D1] bg-white p-8 shadow-[0_30px_60px_-30px_rgba(43,34,32,0.35)]">
      ...
      <div className="mt-7 space-y-1 border-[#EBE1DB] border-t pt-5">
      ...
      <div className="mt-5 border-[#EBE1DB] border-t pt-5">
        <p className="font-serif text-[11px] text-brand italic">
          Our cash offer
        </p>
        <p className="mt-1.5 font-semibold font-serif text-[#2B2220] text-[44px] leading-none tracking-[-0.03em]">
          £244,000
        </p>
        <p className="mt-2 text-[11px] text-stone-500">Locked for 72 hours</p>
      </div>

      <dl className="mt-6 space-y-2.5 border-[#EBE1DB] border-t pt-5 text-[12px]">
        {[
      ...
      <p className="mt-6 border-[#EBE1DB] border-t pt-4 font-serif text-[11px] text-stone-500 italic leading-relaxed">
...
export default function AgentsPage() {
  return (
    <>
      ...
      >
        <span className="font-serif text-[#f0c9c0] italic">
          Sale fallen through?
        </span>
        <span className="ml-3">
      ...
      <section className="relative overflow-hidden px-6 pt-24 pb-20 md:px-12 md:pt-28 md:pb-24">
        ...
        <div className="relative mx-auto max-w-4xl">
          ...
          <h1
            className="mt-7 font-semibold font-serif text-[#2B2220] leading-[0.95] tracking-[-0.03em]"
      ...
      <section className="relative overflow-hidden border-[#EBE1DB]/70 border-y bg-brand-deep px-6 py-24 text-white md:px-12 md:py-28">
        <Monogram
          aria-hidden
      ...
      <section
        id="how"
        className="border-[#EBE1DB]/70 border-b bg-[#F6ECE7] px-6 py-24 md:px-12 md:py-28"
      >
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 lg:grid-cols-[1fr_1.2fr] lg:gap-20">
          ...
          <div className="rounded-sm border border-[#E4D8D1] bg-white p-8 md:p-10">
            ...
            <dl className="mt-6 space-y-5">
              <div className="flex items-baseline justify-between gap-6 border-[#EBE1DB] border-b pb-4">
                <dt>
                ...
                <dd className="font-semibold font-serif text-2xl text-[#2B2220]">
                  £2,800
                </dd>
              </div>
              <div className="flex items-baseline justify-between gap-6 border-[#EBE1DB] border-b pb-4">
      ...
      <section
        id="promise"
        className="relative overflow-hidden border-[#EBE1DB]/70 border-b px-6 py-24 md:px-12 md:py-28"
      >
        <div className="mx-auto max-w-4xl">
          ...
          <dl className="mt-12 divide-y divide-[#EBE1DB] border-[#EBE1DB] border-y">
            {[
              {
      ...
      <section
        id="process"
        className="border-[#EBE1DB]/70 border-b bg-white px-6 py-24 md:px-12 md:py-28"
      >
        <div className="mx-auto max-w-5xl">
          ...
          <ol className="mt-12 divide-y divide-[#EBE1DB] border-[#EBE1DB] border-y">
            {[
              {
                n: '01',
                t: 'Acknowledgement',
      ...
      {/* ————— THE PROOF ————— */}
      <section className="border-[#EBE1DB]/70 border-b bg-brand-deep px-6 py-24 text-white md:px-12 md:py-28">
      ...
      {/* ————— SELLERS LINK ————— */}
      <section className="border-[#EBE1DB]/70 border-b bg-[#F6ECE7] px-6 py-14 md:px-12">
        <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-5 text-center md:flex-row md:text-left">
          <div>
            ...
            <p className="mt-2 font-serif text-[#2B2220] text-xl">
