    ...
    <div>
      <form onSubmit={onSubmit} className="space-y-4">
        <div className="grid gap-4 md:grid-cols-2">
          <label className="block">
            ...
            <input
              ...
              required
              placeholder="M14 5LL"
              className="mt-2 w-full rounded-xl border border-stone-300 bg-white px-4 py-3 font-mono text-[15px] uppercase outline-none focus:border-leaf"
            />
          </label>
          <label className="block">
            <span className="font-serif text-[13px] text-stone-600 italic">
            ...
            <input
              ...
              className="mt-2 w-full rounded-xl border border-stone-300 bg-white px-4 py-3 text-[15px] outline-none focus:border-leaf"
            />
          </label>
        </div>
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-md bg-leaf px-7 py-3.5 font-medium text-sm text-white transition hover:bg-leaf-dark disabled:cursor-not-allowed disabled:opacity-50 md:w-auto"
        >
