...
>
> **Promise note (updated 2026-08-22):** every "4-hour SLA" in this document
> is an INTERNAL ops target only. The public promise (live-site copy is the
> source of truth) is: same-day response, then a confirmed written offer
> within two working days of viewing, binding upon Kept for a week. Never
> advertise the internal target.
