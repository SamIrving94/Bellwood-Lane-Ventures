...
| [`scout-appraisal-review-prompt-2026-09.md`](./scout-appraisal-review-prompt-2026-09.md) | Ready-to-paste Perplexity deep-research prompt that describes the scout (sources, tracks, scoring, gate, orchestration) and the appraisal (AVM blend, risk, offer formula, deal model, deep appraisal) in full, lists the weaknesses we already know, and asks for a critique plus a ranked iteration plan | 2026-09 |
| [`scout-appraisal-review-2026-09.md`](./scout-appraisal-review-2026-09.md) | The report that came back: keep two dimensions but gate then rank instead of adding points; no-price leads need their own queue; the AVM's time adjustment, distance-0 comps, derivative pillar and fixed intervals matter more than blend weights; do not discount value by seller type, use one residual max-offer model; London refurb bands are light; build the frozen Land Registry backtest first; ten ranked changes | 2026-09 |
